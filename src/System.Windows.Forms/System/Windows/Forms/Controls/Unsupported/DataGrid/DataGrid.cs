    ...
    public class DataGrid : Control, ISupportInitialize, IDataGridEditingService
    {
        ...
        public BorderStyle BorderStyle
        {
            ...
            set
            {
                ...
                if (!DataGridClientUtils.IsEnumValid(value, (int)value, (int)BorderStyle.None, (int)BorderStyle.Fixed3D))
                {
        ...
        public DataGridLineStyle GridLineStyle
        {
            ...
            set
            {
                ...
                if (!DataGridClientUtils.IsEnumValid(value, (int)value, (int)DataGridLineStyle.None, (int)DataGridLineStyle.Solid))
                {
        ...
        public DataGridParentRowsLabelStyle ParentRowsLabelStyle
        {
            ...
            set
            {
                ...
                if (!DataGridClientUtils.IsEnumValid(value, (int)value, (int)DataGridParentRowsLabelStyle.None, (int)DataGridParentRowsLabelStyle.Both))
                {
        ...
        public int PreferredColumnWidth
        {
            ...
            set
            {
                ...
                {
                    int previousPreferredColumnWidth = preferredColumnWidth;
                    preferredColumnWidth = value;
                    ApplyPreferredColumnWidthToCurrentTable(previousPreferredColumnWidth);
                    PreferredColumnWidthChanged(this, EventArgs.Empty);
                }
            }
        }

        private void ApplyPreferredColumnWidthToCurrentTable(int previousPreferredColumnWidth)
        {
            ...
            {
                DataGridColumnStyle column = columns[columnIndex];

                if (column.PropertyDescriptor is null || column._width != previousPreferredColumnWidth)
                {
                    continue;
                }

                column._width = preferredColumnWidth;
            }
        }
        ...
        */
        ...
        protected override void OnMouseWheel(MouseEventArgs e)
        {
            ...
            gridState[GRIDSTATE_isScrolling] = true;
            wheelDelta += e.Delta;
            float movePerc = (float)wheelDelta / DataGridNativeMethods.WHEEL_DELTA;
