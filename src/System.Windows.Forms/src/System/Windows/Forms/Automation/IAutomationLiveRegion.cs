...
namespace System.Windows.Forms.Automation
{
    ...
    /// The feature is available in applications that are recompiled to target .NET
    /// Framework 4.7.3 or opt in into this functionality using compatibility switches.
    /// </summary>
