...
namespace System.Windows.Forms
{
    ...
    public class ComboBox : ListControl
    {
        ...
        internal ChildAccessibleObject ChildEditAccessibleObject
        {
            get
            {
                if (childEditAccessibleObject is null)
                {
        ...
        internal ChildAccessibleObject ChildListAccessibleObject
        {
            get
            {
                if (childListAccessibleObject is null)
                {
        ...
        internal AccessibleObject ChildTextAccessibleObject
        {
            get
            {
                if (childTextAccessibleObject is null)
                {
        ...
        public int GetItemHeight(int index)
        {
            ...
            if (index < 0 || itemsCollection is null || index >= itemsCollection.Count)
            {
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            //
            Debug.Assert(childEdit is null, "Child edit window already attached");
            Debug.Assert(childListBox is null, "Child listbox window already attached");

            bool ok = childEdit is null && childListBox is null;
        ...
        {
            if (!IsHandleCreated || childEdit is null)
            {
                return;
            }
        ...
        public override string ToString()
        {
            ...
            return s + ", Items.Count: " + ((itemsCollection is null) ? "0" : itemsCollection.Count.ToString(CultureInfo.CurrentCulture));
        }
