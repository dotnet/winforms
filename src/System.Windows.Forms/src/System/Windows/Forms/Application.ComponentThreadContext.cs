...
public sealed partial class Application
{
        ...
        IManagedWrapper<IMsoComponent>
    {
        ...
        private static readonly Dictionary<uint, ComponentThreadContext> s_contextHash = [];
        ...
        [ThreadStatic]
        private static ComponentThreadContext? t_currentThreadContext;
        ...
        /// </summary>
        public unsafe ComponentThreadContext()
        {
            HANDLE target;
        ...
        private static void ExitCommon(bool disposing)
        {
            lock (s_tcInternalSyncObject)
            {
                ...
                {
                    ComponentThreadContext[] ctxs = new ComponentThreadContext[s_contextHash.Values.Count];
        ...
        /// </summary>
        internal static ComponentThreadContext FromCurrent() => t_currentThreadContext ?? new ComponentThreadContext();

        /// <summary>
        ///  Retrieves a ThreadContext object for the given thread ID
        /// </summary>
        internal static ComponentThreadContext? FromId(uint id)
        {
            if (!s_contextHash.TryGetValue(id, out ComponentThreadContext? context) && id == PInvoke.GetCurrentThreadId())
            {
                context = new ComponentThreadContext();
            }
