...
public partial class DataGridViewComboBoxCell : DataGridViewCell
{
    ...
    {
        get => Properties.TryGetValue(s_propComboBoxCellDisplayStyle, out DataGridViewComboBoxDisplayStyle displayStyle)
    ...
    {
        get => Properties.TryGetValue(s_propComboBoxCellDisplayStyleForCurrentCellOnly,
            out bool displayStyleForCurrentCellOnly) && displayStyleForCurrentCellOnly;
        set
        {
    ...
    {
        get => Properties.TryGetValue(s_propComboBoxCellDropDownWidth, out int dropDownWidth) ? dropDownWidth : 1;
        set
        {
            if (value < 1)
            {
