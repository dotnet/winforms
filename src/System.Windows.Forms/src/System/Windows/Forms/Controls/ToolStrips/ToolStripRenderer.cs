...
public abstract class ToolStripRenderer
{
    ...
    internal int previousDeviceDpi = ScaleHelper.InitialSystemDpi;
    ...
    protected static void ScaleArrowOffsetsIfNeeded()
    {
        ...
        offset4X = ScaleHelper.ScaleToInitialSystemDpi(OFFSET_4PIXELS);
        offset4Y = ScaleHelper.ScaleToInitialSystemDpi(OFFSET_4PIXELS);
    ...
    protected static void ScaleArrowOffsetsIfNeeded(int dpi)
    {
        ...
        offset4X = ScaleHelper.ScaleToDpi(OFFSET_4PIXELS, dpi);
        offset4Y = ScaleHelper.ScaleToDpi(OFFSET_4PIXELS, dpi);
    }
    ...
    protected virtual void OnRenderArrow(ToolStripArrowRenderEventArgs e)
    {
        ...
        using (var brush = e.ArrowColor.GetCachedSolidBrushScope())
        {
            ...
            if (e.Item is not null && e.Item.DeviceDpi != previousDeviceDpi && ScaleHelper.IsThreadPerMonitorV2Aware)
            {
            ...
            int horizontalOffset = ScaleHelper.IsScalingRequirementMet ? offset4X - Offset2X : Offset2X;
