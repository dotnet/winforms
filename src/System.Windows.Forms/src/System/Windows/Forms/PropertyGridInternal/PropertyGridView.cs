...
namespace System.Windows.Forms.PropertyGridInternal
{
    ...
    IServiceProvider
    {
        ...
        {
            if (ownerGrid.lineBrush is null)
            {
        ...
        {
            if (ownerGrid.selectedItemWithFocusBackBrush is null)
            {
            ...
            internal override UiaCore.IRawElementProviderFragment FragmentNavigate(UiaCore.NavigateDirection direction)
            {
                switch (direction)
                {
                    ...
                    case UiaCore.NavigateDirection.PreviousSibling:
                        ...
                        if (gridViewListBoxAccessibleObject is not null)
                        {
        ...
        private class GridViewListBoxAccessibleObject : ControlAccessibleObject
        {
            ...
            internal void SetListBoxItemFocus()
            {
                ...
                if (selectedItem is not null && _itemAccessibleObjects[selectedItem] is AccessibleObject itemAccessibleObject)
                {
        ...
        private class GridViewEdit : TextBox, IMouseHookClient
        {
            ...
            protected class GridViewEditAccessibleObject : ControlAccessibleObject
            {
                ...
                internal override UiaCore.IRawElementProviderFragment FragmentNavigate(UiaCore.NavigateDirection direction)
                {
                    if (direction == UiaCore.NavigateDirection.Parent && propertyGridView.SelectedGridEntry is not null)
                    {
