...
namespace System.Windows.Forms
{
    ...
    public class LinkLabel : Label, IButtonControl
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (links is not null && links.Count == 1)
                        {
        ...
        {
            if (links is null || links.Count != 1 || Text is null)
            {
                return false;
            }
            StringInfo stringInfo = new StringInfo(Text);
