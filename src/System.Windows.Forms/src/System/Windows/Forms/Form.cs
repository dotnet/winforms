        ...
        public static SizeF GetAutoScaleSize(Font font)
        {
            ...
            try
            {
                using (Graphics graphics = Graphics.FromHwndInternal(IntPtr.Zero /*screen*/))
                {
                    ...
                    double magicNumber = 44.549996948242189; // chosen for compatibility with legacy versions of windows forms, but approximately magicString.Length
        ...
        private void WmClose(ref Message m)
        {
            ...
            if (m.Msg != (int)User32.WM.ENDSESSION)
            {
                if (Modal)
                {
                    ...
                    // but we cannot, because we didn't to this in legacy versions, and doing so
