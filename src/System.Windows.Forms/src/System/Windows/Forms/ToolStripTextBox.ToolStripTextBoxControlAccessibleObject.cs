    ...
    private class ToolStripTextBoxControlAccessibleObject : TextBoxBaseAccessibleObject
    {
        ...
        internal override object? GetPropertyValue(UIA_PROPERTY_ID propertyID)
            => propertyID switch
            {
                ...
                UIA_PROPERTY_ID.UIA_IsOffscreenPropertyId when this.TryGetOwnerAs(out TextBox? owner) => GetIsOffscreenPropertyValue(owner.ToolStripControlHost?.Placement, Bounds),
