...
namespace System.Windows.Forms
{
    ...
    public static partial class ControlPaint
    {
        ...
        public static IntPtr CreateHBitmapColorMask(Bitmap bitmap, IntPtr monochromeMask)
        {
            ...
            PInvoke.SetBkColor(targetDC, 0x00ffffff);    // white
            PInvoke.SetTextColor(targetDC, 0x00000000);  // black
...
#pragma warning restore IDE0060
        ...
        public static void DrawReversibleFrame(Rectangle rectangle, Color backColor, FrameStyle style)
        {
            ...
            {
                FrameStyle.Dashed => (HGDIOBJ)PInvoke.CreatePen(PEN_STYLE.PS_DOT, cWidth: 1, (uint)ColorTranslator.ToWin32(backColor)).Value,
                FrameStyle.Thick => (HGDIOBJ)PInvoke.CreatePen(PEN_STYLE.PS_SOLID, cWidth: 2, (uint)ColorTranslator.ToWin32(backColor)).Value,
                _ => default
            });
            ...
            PInvoke.SetBkColor(desktopDC, (uint)ColorTranslator.ToWin32(graphicsColor));
        ...
        public static void FillReversibleRectangle(Rectangle rectangle, Color backColor)
        {
            ...
            using var desktopDC = new User32.GetDcScope(
                ...
                IntPtr.Zero,
                User32.DCX.WINDOW | User32.DCX.LOCKWINDOWUPDATE | User32.DCX.CACHE);
            using PInvoke.ObjectScope brush = new(PInvoke.CreateSolidBrush((uint)ColorTranslator.ToWin32(backColor)));
            using PInvoke.SetRop2Scope ropScope = new(desktopDC, rop2);
