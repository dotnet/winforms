...
namespace System.Windows.Forms
{
    ...
    public class TreeNode : MarshalByRefObject, ICloneable, ISerializable
    {
        ...
        public IntPtr Handle
        {
            get
            {
                if (handle == IntPtr.Zero && TreeView is not null)
                {
        ...
        public int ImageIndex
        {
            ...
            {
                TreeView tv = TreeView;
                if (ImageIndexer.Index != ImageList.Indexer.DefaultIndex && tv is not null && tv.ImageList is not null && ImageIndexer.Index >= tv.ImageList.Images.Count)
                {
        ...
        public int SelectedImageIndex
        {
            ...
            {
                TreeView tv = TreeView;
                if (SelectedImageIndexer.Index != ImageList.Indexer.DefaultIndex && tv is not null && tv.ImageList is not null && SelectedImageIndexer.Index >= tv.ImageList.Images.Count)
                {
                    return tv.ImageList.Images.Count - 1;
                }
