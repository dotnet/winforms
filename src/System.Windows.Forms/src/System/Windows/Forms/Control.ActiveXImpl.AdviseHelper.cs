...
#pragma warning restore SYSLIB0004 // Type or member is obsolete
            ...
            internal sealed class ComConnectionPointContainer : SafeIUnknown
            {
                public ComConnectionPointContainer(object obj, bool addRefIntPtr)
                    : base(obj, addRefIntPtr, typeof(IConnectionPointContainer.Interface).GUID)
                {
            ...
            /// </summary>
            internal sealed class ComConnectionPoint : SafeIUnknown
            {
                public ComConnectionPoint(object obj, bool addRefIntPtr)
                    : base(obj, addRefIntPtr, IID.GetRef<IConnectionPoint>())
                {
                    _vtbl = LoadVtable<VTABLE>();
                }
