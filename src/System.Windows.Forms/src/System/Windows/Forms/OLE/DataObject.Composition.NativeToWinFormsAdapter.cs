    ...
    internal unsafe partial class Composition
    {
        ...
        private unsafe class NativeToWinFormsAdapter : IDataObject, Com.IDataObject.Interface
        {
            ...
            private static object? ReadObjectOrStreamFromHGLOBAL<T>(HGLOBAL hglobal, Func<TypeName, Type> resolver, bool restrictDeserialization, bool legacyMode)
            {
                ...
                return BinaryFormatUtilities.ReadObjectFromStream<T>(stream, resolver, restrictDeserialization, legacyMode);
            }
            ...
            {
                TryGetDataInternal(format, GetDataResolver(), autoConvert, legacyMode: true, out object? data);
                return data;
            }
