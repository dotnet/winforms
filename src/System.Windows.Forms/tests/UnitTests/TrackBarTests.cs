...
namespace System.Windows.Forms.Tests
{
    ...
    public class TrackBarTests : IClassFixture<ThreadExceptionFixture>
    {
        ...
        public void TrackBar_Handle_GetWithMaximum_Success()
        {
            ...
            Assert.NotEqual(IntPtr.Zero, control.Handle);
            Assert.Equal(11, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMAX));
        }
        ...
        public void TrackBar_Handle_GetWithMinimum_Success()
        {
            ...
            Assert.NotEqual(IntPtr.Zero, control.Handle);
            Assert.Equal(11, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMIN));
        }
        ...
        public void TrackBar_Handle_GetWithValue_Success(RightToLeft rightToLeft, bool rightToLeftLayout, int expected)
        {
            ...
            Assert.NotEqual(IntPtr.Zero, control.Handle);
            Assert.Equal(expected, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETPOS));
        }
        ...
        public void TrackBar_Handle_GetWithValueVertical_Success()
        {
            ...
            Assert.NotEqual(IntPtr.Zero, control.Handle);
            Assert.Equal(5, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETPOS));
        }
        ...
        public void TrackBar_Handle_GetWithLargeChange_Success()
        {
            ...
            Assert.NotEqual(IntPtr.Zero, control.Handle);
            Assert.Equal(11, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETPAGESIZE));
        }
        ...
        public void TrackBar_Handle_GetWithSmallChange_Success()
        {
            ...
            Assert.NotEqual(IntPtr.Zero, control.Handle);
            Assert.Equal(11, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETLINESIZE));
        }
        ...
        public void TrackBar_LargeChange_SetWithHandle_GetReturnsExpected(int value)
        {
            ...
            control.LargeChange = value;
            Assert.Equal(value, control.LargeChange);
            Assert.Equal(value, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETPAGESIZE));
            Assert.True(control.IsHandleCreated);
            Assert.Equal(0, invalidatedCallCount);
            Assert.Equal(0, styleChangedCallCount);
            Assert.Equal(0, createdCallCount);
        ...
        public void TrackBar_Maximum_SetWithHandle_GetReturnsExpected(int value, int expectedInvalidatedCallCount)
        {
            ...
            Assert.Equal(5, control.LargeChange);
            Assert.Equal(1, control.SmallChange);
            Assert.Equal(0, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMIN));
            Assert.Equal(value, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMAX));
            Assert.Equal(0, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETPOS));
            Assert.True(control.IsHandleCreated);
        ...
        public void TrackBar_Maximum_SetLessThanValueAndMinimumWithHandle_SetsValueAndMinimum()
        {
            ...
            Assert.Equal(5, control.LargeChange);
            Assert.Equal(1, control.SmallChange);
            Assert.Equal(5, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMIN));
            Assert.Equal(5, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMAX));
            Assert.Equal(5, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETPOS));
            Assert.True(control.IsHandleCreated);
        ...
        public void TrackBar_Minimum_SetWithHandle_GetReturnsExpected(int value, int expectedInvalidatedCallCount)
        {
            ...
            Assert.Equal(5, control.LargeChange);
            Assert.Equal(1, control.SmallChange);
            Assert.Equal(value, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMIN));
            Assert.Equal(10, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMAX));
            Assert.Equal(5, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETPOS));
            Assert.True(control.IsHandleCreated);
            Assert.Equal(expectedInvalidatedCallCount, invalidatedCallCount);
            Assert.Equal(0, styleChangedCallCount);
        ...
        public void TrackBar_Minimum_SetGreaterThanValueAndMaximumWithHandle_SetsValueAndMinimum()
        {
            ...
            Assert.Equal(5, control.LargeChange);
            Assert.Equal(1, control.SmallChange);
            Assert.Equal(12, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMIN));
            Assert.Equal(12, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMAX));
            Assert.Equal(12, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETPOS));
            Assert.True(control.IsHandleCreated);
            Assert.Equal(1, invalidatedCallCount);
            Assert.Equal(0, styleChangedCallCount);
            Assert.Equal(0, createdCallCount);
        ...
        public void TrackBar_SmallChange_SetWithHandle_GetReturnsExpected(int value)
        {
            ...
            control.SmallChange = value;
            Assert.Equal(value, control.SmallChange);
            Assert.Equal(value, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETLINESIZE));
            Assert.True(control.IsHandleCreated);
            Assert.Equal(0, invalidatedCallCount);
            Assert.Equal(0, styleChangedCallCount);
            Assert.Equal(0, createdCallCount);
        ...
        public void TrackBar_Value_SetWithHandle_GetReturnsExpected(Orientation orientation, RightToLeft rightToLeft, bool rightToLeftLayout, int value, int expectedPos)
        {
            ...
            Assert.Equal(5, control.LargeChange);
            Assert.Equal(1, control.SmallChange);
            Assert.Equal(expectedPos, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETPOS));
            Assert.True(control.IsHandleCreated);
            Assert.Equal(0, invalidatedCallCount);
            Assert.Equal(0, styleChangedCallCount);
            Assert.Equal(0, createdCallCount);
        ...
        public void TrackBar_SetRange_InvokeWithHandle_Success(int minValue, int maxValue, int expectedMinimum, int expectedMaximum, int expectedValue, int expectedInvalidatedCallCount)
        {
            ...
            Assert.Equal(expectedMaximum, control.Maximum);
            Assert.Equal(expectedValue, control.Value);
            Assert.Equal(expectedMinimum, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMIN));
            Assert.Equal(expectedMaximum, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETRANGEMAX));
            Assert.Equal(expectedValue, User32.SendMessageW(control, (User32.WM)ComCtl32.TBM.GETPOS));
            Assert.True(control.IsHandleCreated);
            Assert.Equal(expectedInvalidatedCallCount, invalidatedCallCount);
            Assert.Equal(0, styleChangedCallCount);
            Assert.Equal(0, createdCallCount);
