    ...
    public class ComboBox_ComboBoxItemAccessibleObjectTests
    {
        ...
        public static IEnumerable<object[]> ComboBoxItemAccessibleObject_Bounds_ReturnsCorrect_ForVisibleItems_IfComboBoxIsScrollable_TestData()
        {
            foreach (ComboBoxStyle comboBoxStyle in Enum.GetValues(typeof(ComboBoxStyle)))
            {
                ...
                {
                    yield return new object[] { comboBoxStyle, index };
                }
            }
        }
        ...
        public void ComboBoxItemAccessibleObject_Bounds_ReturnsCorrect_ForVisibleItems_IfComboBoxIsScrollable(ComboBoxStyle comboBoxStyle, int itemIndex)
        {
            using ComboBox comboBox = new ComboBox();
            comboBox.IntegralHeight = false;
            comboBox.DropDownStyle = comboBoxStyle;
            ...
            Point expectedPosition = new Point(x, y + initialYPosition);
        ...
        public void ComboBoxItemAccessibleObject_Bounds_ReturnsCorrect_ForDifferentHeightItems(ComboBoxStyle comboBoxStyle, int itemIndex)
        {
            ...
            int height = DifferentHeightComboBox.GetCustomItemHeight(itemIndex);
            ...
            Rectangle expectedRect = new Rectangle(x, y, width, height);
