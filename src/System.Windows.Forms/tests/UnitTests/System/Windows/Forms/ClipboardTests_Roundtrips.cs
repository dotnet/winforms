...
{
    private readonly string _customFormat = "Custom Format";
    ...
    public void Clipboard_RoundTrips_Primitive(object value)
    {
        using (BinaryFormatterScope scope = new(enable: true))
        {
            Clipboard.SetData(_customFormat, value);
        }

        Clipboard.GetData(_customFormat).Should().Be(value);
        Thread.Sleep(500);
    }

    [WinFormsTheory]
    [MemberData(nameof(NotSupportedException_TestData))]
    public void Clipboard_RoundTrips_NotSupportedException(NotSupportedException value)
    {
        using (BinaryFormatterScope scope = new(enable: true))
        {
            Clipboard.SetData(_customFormat, value);
        ...
        Clipboard.GetData(_customFormat).Should().BeEquivalentTo(value);
        Thread.Sleep(500);
    }

    [WinFormsFact]
    public void Clipboard_RoundTrips_NotSupportedException_DataLoss()
    {
        ...
        Clipboard.GetData(_customFormat).Should().BeEquivalentTo(new NotSupportedException("Error message", null));
        Thread.Sleep(500);
    }

    [WinFormsTheory]
    [MemberData(nameof(PrimitiveListObjects_TheoryData))]
    public void Clipboard_RoundTrips_PrimitiveList(IList value)
    {
        using (BinaryFormatterScope scope = new(enable: true))
        {
            Clipboard.SetData(_customFormat, value);
    ...
    public void Clipboard_RoundTrips_PrimitiveArray(Array value)
    {
        using (BinaryFormatterScope scope = new(enable: true))
        {
            Clipboard.SetData(_customFormat, value);
    ...
    public void Clipboard_RoundTrips_PrimitiveArrayList(ArrayList value)
    {
        using (BinaryFormatterScope scope = new(enable: true))
        {
            Clipboard.SetData(_customFormat, value);
    ...
    public void Clipboard_RoundTrips_PrimitiveHashtable(Hashtable value)
    {
        using (BinaryFormatterScope scope = new(enable: true))
        {
            Clipboard.SetData(_customFormat, value);
    ...
    [WinFormsFact]
    public void Clipboard_RoundTrips_ImageList()
    {
        ...
        Clipboard.GetData(_customFormat).Should().BeOfType<ImageListStreamer>();
        Thread.Sleep(500);
    }

    [WinFormsFact]
    public void Clipboard_RoundTrips_Bitmap()
    {
        ...
        Clipboard.GetData(_customFormat).Should().BeOfType<Bitmap>().Subject.Size.Should().BeEquivalentTo(new Size(10, 10));
        Thread.Sleep(500);
    }

    [WinFormsTheory]
    [MemberData(nameof(Lists_UnsupportedTestData))]
    public void Clipboard_RoundTrips_Unsupported(IList value)
    {
        using (BinaryFormatterScope scope = new(enable: true))
        {
            Clipboard.SetData(_customFormat, value);
        ...
        Clipboard.GetData(_customFormat).Should().BeOfType<NotSupportedException>();
        Thread.Sleep(500);
    }
}
