...
public class ListBoxObjectCollectionTests
{
    ...
    public unsafe void ListBoxObjectCollection_Item_SetNotSortedWithHandle_GetReturnsExpected()
    {
        ...
        Assert.Equal(3, (int)PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETCOUNT));
        PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETTEXT, 0, (nint)textBuffer);
        Assert.Equal("4", new string(textBuffer));
        PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETTEXT, 1, (nint)textBuffer);
        Assert.Equal("1", new string(textBuffer));
        PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETTEXT, 2, (nint)textBuffer);
    ...
    public unsafe void ListBoxObjectCollection_Add_NotSortedWithHandle_Success()
    {
        ...
        Assert.Equal(0, styleChangedCallCount);
        Assert.Equal(0, createdCallCount);
        Assert.Equal(1, (int)PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETCOUNT));
        PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETTEXT, 0, (nint)textBuffer);
        Assert.Equal("2", new string(textBuffer));
        ...
        Assert.Equal(0, styleChangedCallCount);
        Assert.Equal(0, createdCallCount);
        Assert.Equal(2, (int)PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETCOUNT));
        PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETTEXT, 0, (nint)textBuffer);
        Assert.Equal("2", new string(textBuffer));
        PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETTEXT, 1, (nint)textBuffer);
        Assert.Equal("1", new string(textBuffer));
        ...
        Assert.Equal(0, styleChangedCallCount);
        Assert.Equal(0, createdCallCount);
        Assert.Equal(4, (int)PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETCOUNT));
        PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETTEXT, 0, (nint)textBuffer);
        Assert.Equal("2", new string(textBuffer));
        PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETTEXT, 1, (nint)textBuffer);
        Assert.Equal("1", new string(textBuffer));
        PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETTEXT, 2, (nint)textBuffer);
        Assert.Equal("1", new string(textBuffer));
        PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETTEXT, 3, (nint)textBuffer);
        Assert.Equal("3", new string(textBuffer));
    }
    ...
    public unsafe void ListBoxObjectCollection_Add_CreateHandle_Success()
    {
        ...
        Assert.Equal(0, (int)PInvoke.SendMessage(owner, (WM)PInvoke.LB_GETCOUNT));
    }
