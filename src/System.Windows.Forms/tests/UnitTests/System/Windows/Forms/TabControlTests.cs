...
namespace System.Windows.Forms.Tests
{
    ...
    public class TabControlTests : IClassFixture<ThreadExceptionFixture>
    {
        ...
        public void TabControl_Handle_GetNoImageList_Success()
        {
            using var control = new TabControl();
            Assert.NotEqual(IntPtr.Zero, control.Handle);
            Assert.Equal(0, User32.SendMessageW(control, (User32.WM)ComCtl32.TCM.GETIMAGELIST));
        }
        ...
        public void TabControl_Handle_GetWithImageList_Success()
        {
            ...
            Assert.NotEqual(IntPtr.Zero, control.Handle);
            Assert.Equal((nint)imageList.Handle, User32.SendMessageW(control, (User32.WM)ComCtl32.TCM.GETIMAGELIST));
        }
        ...
        public void TabControl_Handle_GetItemsEmpty_Success()
        {
            using var control = new TabControl();
            Assert.NotEqual(IntPtr.Zero, control.Handle);
            Assert.Equal(0, User32.SendMessageW(control, (User32.WM)ComCtl32.TCM.GETITEMCOUNT));
        }
        ...
        public unsafe void TabControl_Handle_GetItems_Success(string text, string expectedText)
        {
            ...
            Assert.NotEqual(IntPtr.Zero, control.Handle);
            Assert.Equal(3, User32.SendMessageW(control, (User32.WM)ComCtl32.TCM.GETITEMCOUNT));
            ...
            // Get item 0.
            Assert.Equal(1, User32.SendMessageW(control, (User32.WM)ComCtl32.TCM.GETITEMW, 0, ref item));
            ...
            // Get item 1.
            Assert.Equal(1, User32.SendMessageW(control, (User32.WM)ComCtl32.TCM.GETITEMW, 1, ref item));
            ...
            // Get item 2.
            Assert.Equal(1, User32.SendMessageW(control, (User32.WM)ComCtl32.TCM.GETITEMW, 2, ref item));
            Assert.Equal((ComCtl32.TCIS)0, item.dwState);
            Assert.Equal(IntPtr.Zero, item.lParam);
            Assert.Equal(int.MaxValue, item.cchTextMax);
            Assert.Empty(new string(item.pszText));
        ...
        public void TabControl_ImageList_RecreateHandleWithHandle_Success()
        {
            ...
            Assert.Equal(1, recreateCallCount1);
            Assert.Same(imageList1, control.ImageList);
            Assert.Equal((nint)imageList1.Handle, User32.SendMessageW(control, (User32.WM)ComCtl32.TCM.GETIMAGELIST));
            Assert.True(control.IsHandleCreated);
            Assert.Equal(0, invalidatedCallCount);
            Assert.Equal(0, styleChangedCallCount);
            Assert.Equal(0, createdCallCount);
            ...
            Assert.Equal(2, recreateCallCount1);
            Assert.Same(imageList2, control.ImageList);
            Assert.Equal((nint)imageList2.Handle, User32.SendMessageW(control, (User32.WM)ComCtl32.TCM.GETIMAGELIST));
            Assert.True(control.IsHandleCreated);
            Assert.Equal(0, invalidatedCallCount);
            Assert.Equal(0, styleChangedCallCount);
            Assert.Equal(0, createdCallCount);
