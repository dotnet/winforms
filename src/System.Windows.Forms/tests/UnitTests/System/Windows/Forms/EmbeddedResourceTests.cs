...
public class EmbeddedResourceTests
{
    ...
    public static TheoryData<string> ExpectedIconNames()
        => (TheoryData<string>)ExpectedIconNamesString.Split(Environment.NewLine).ToTheoryData();
    ...
    public static TheoryData<string> ExpectedCursorNames()
         => (TheoryData<string>)ExpectedCursorNamesString.Split(Environment.NewLine).ToTheoryData();
