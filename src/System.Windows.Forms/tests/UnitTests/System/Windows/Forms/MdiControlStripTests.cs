...
namespace System.Windows.Forms.Tests
{
    ...
    public class MdiControlStripTests : IClassFixture<ThreadExceptionFixture>
    {
        ...
        public void MdiControlStrip_Ctor_VerifyMenuItemsInRightOrder()
        {
            ...
            ToolStripMenuItem system = mdiControlStrip.TestAccessor().Dynamic.system;
            ToolStripMenuItem close = mdiControlStrip.TestAccessor().Dynamic.close;
            ToolStripMenuItem minimize = mdiControlStrip.TestAccessor().Dynamic.minimize;
            ToolStripMenuItem restore = mdiControlStrip.TestAccessor().Dynamic.restore;
        ...
        public void MdiControlStrip_Ctor_VerifyMenuItemsHaveImages()
        {
            ...
            {
                mdiControlStrip.TestAccessor().Dynamic.system,
                mdiControlStrip.TestAccessor().Dynamic.close,
                mdiControlStrip.TestAccessor().Dynamic.minimize,
                mdiControlStrip.TestAccessor().Dynamic.restore
            };
