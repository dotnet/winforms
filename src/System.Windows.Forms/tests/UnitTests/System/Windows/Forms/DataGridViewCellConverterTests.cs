...
public class DataGridViewCellConverterTests
{
    ...
    {
        _converter.CanConvertTo(null, destinationType).Should().Be(expected);
    }
    ...
    public void ConvertTo_InstanceDescriptorWithDataGridViewCell_ReturnsInstanceDescriptor()
    {
        ...
        _converter.ConvertTo(null, CultureInfo.InvariantCulture, cell, destinationType).Should().NotBeNull();
        _converter.ConvertTo(null, CultureInfo.InvariantCulture, cell, destinationType).Should().BeOfType<InstanceDescriptor>();
    }
    ...
    public void ConvertTo_InstanceDescriptorWithNonDataGridViewCell_ThrowsNotSupportedException()
    {
        ...
        Action action = () => _converter.ConvertTo(null, CultureInfo.InvariantCulture, value, destinationType);
    ...
    public void ConvertTo_OtherType_ReturnsStringRepresentation()
    {
        ...
        _converter.ConvertTo(null, CultureInfo.InvariantCulture, cell, destinationType).Should().NotBeNull();
        _converter.ConvertTo(null, CultureInfo.InvariantCulture, cell, destinationType).Should().BeOfType<string>();
        _converter.ConvertTo(null, CultureInfo.InvariantCulture, cell, destinationType).Should().Be(cell.ToString());
    }
}
