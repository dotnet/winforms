...
public partial class BinaryFormatUtilitiesTests : IDisposable
{
    ...
    {
        _stream.Position = 0;
        return Utilities.ReadObjectFromStream<object>(_stream, DataObject.GetDataResolver(), restrictDeserialization: false, legacyMode : true);
    }
    ...
    public void BinaryFormatUtilities_RoundTrip_Simple(object value)
    {
        ...
        ReadObjectFromStream().Should().Be(value);
    }
    ...
    public void BinaryFormatUtilities_RoundTrip_NotSupportedException_DataLoss()
    {
        ...
        ReadObjectFromStream().Should().BeEquivalentTo(new NotSupportedException("Error message", null));
    }
    ...
    public void BinaryFormatUtilities_RoundTrip_ImageList()
    {
        ...
        ReadObjectFromStream().Should().BeOfType<ImageListStreamer>();
    }
    ...
    public void BinaryFormatUtilities_RoundTrip_Bitmap()
    {
       ...
       ReadObjectFromStream().Should().BeOfType<Bitmap>().Subject.Size.Should().BeEquivalentTo(new Size(10, 10));
    }
    ...
    public void BinaryFormatUtilities_RoundTrip_Unsupported(IList value)
    {
        ...
        ReadObjectFromStream().Should().BeOfType<NotSupportedException>();
    }
}
