...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiPrintUnitConvertTests
    {
        private const string ProjectName = "MauiPrintUnitConvertTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiPrintUnitConvertTests(string scenarioName)
        {
