...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiBindingSourceTests
    {
        private const string ProjectName = "MauiBindingSourceTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiBindingSourceTests(string scenarioName)
        {
