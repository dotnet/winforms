...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiResXResourceReaderTests
    {
        private const string ProjectName = "MauiResXResourceReaderTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiResXResourceReaderTests(string scenarioName)
        {
