...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicCellPaintingTests
    {
        private const string ProjectName = "MauiDGV_BasicCellPaintingTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicCellPaintingTests(string scenarioName)
        {
