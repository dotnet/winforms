...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDblBuffSecurityChecksTests
    {
        private const string ProjectName = "MauiDblBuffSecurityChecksTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDblBuffSecurityChecksTests(string scenarioName)
        {
