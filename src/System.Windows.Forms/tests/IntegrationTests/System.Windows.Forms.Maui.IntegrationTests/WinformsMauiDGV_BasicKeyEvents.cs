...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicKeyEvents
    {
        private const string ProjectName = "MauiDGV_BasicKeyEvents";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicKeyEvents(string scenarioName)
        {
