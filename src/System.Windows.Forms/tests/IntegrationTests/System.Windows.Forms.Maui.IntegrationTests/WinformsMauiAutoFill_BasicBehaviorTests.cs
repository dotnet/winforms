...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiAutoFill_BasicBehaviorTests
    {
        private const string ProjectName = "MauiAutoFill_BasicBehaviorTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiAutoFill_BasicBehaviorTests(string scenarioName)
        {
