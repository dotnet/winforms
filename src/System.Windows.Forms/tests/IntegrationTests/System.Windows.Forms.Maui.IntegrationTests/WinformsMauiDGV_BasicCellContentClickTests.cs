...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicCellContentClickTests
    {
        private const string ProjectName = "MauiDGV_BasicCellContentClickTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicCellContentClickTests(string scenarioName)
        {
