...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicCellValuePushedTests
    {
        private const string ProjectName = "MauiDGV_BasicCellValuePushedTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicCellValuePushedTests(string scenarioName)
        {
