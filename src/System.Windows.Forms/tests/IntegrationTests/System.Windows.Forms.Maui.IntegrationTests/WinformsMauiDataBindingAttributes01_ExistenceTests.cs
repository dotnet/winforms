...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDataBindingAttributes01_ExistenceTests
    {
        private const string ProjectName = "MauiDataBindingAttributes01_ExistenceTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDataBindingAttributes01_ExistenceTests(string scenarioName)
        {
