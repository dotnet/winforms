...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicRowDirtyStateNeededTests
    {
        private const string ProjectName = "MauiDGV_BasicRowDirtyStateNeededTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicRowDirtyStateNeededTests(string scenarioName)
        {
