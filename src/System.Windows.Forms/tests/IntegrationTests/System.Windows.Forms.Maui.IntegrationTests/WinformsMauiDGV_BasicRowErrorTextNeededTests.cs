...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicRowErrorTextNeededTests
    {
        private const string ProjectName = "MauiDGV_BasicRowErrorTextNeededTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicRowErrorTextNeededTests(string scenarioName)
        {
