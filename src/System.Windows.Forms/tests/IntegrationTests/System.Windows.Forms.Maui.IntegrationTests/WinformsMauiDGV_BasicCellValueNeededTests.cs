...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicCellValueNeededTests
    {
        private const string ProjectName = "MauiDGV_BasicCellValueNeededTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicCellValueNeededTests(string scenarioName)
        {
