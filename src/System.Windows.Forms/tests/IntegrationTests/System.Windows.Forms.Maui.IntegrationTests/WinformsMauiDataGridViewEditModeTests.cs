...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDataGridViewEditModeTests
    {
        private const string ProjectName = "MauiDataGridViewEditModeTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDataGridViewEditModeTests(string scenarioName)
        {
