...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicFocusEvensTests
    {
        private const string ProjectName = "MauiDGV_BasicFocusEvensTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicFocusEvensTests(string scenarioName)
        {
