...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiSelectionNightliesTests
    {
        private const string ProjectName = "MauiSelectionNightliesTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiSelectionNightliesTests(string scenarioName)
        {
