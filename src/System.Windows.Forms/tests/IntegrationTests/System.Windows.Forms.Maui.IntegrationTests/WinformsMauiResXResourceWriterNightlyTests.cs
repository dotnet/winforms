...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiResXResourceWriterNightlyTests
    {
        private const string ProjectName = "MauiResXResourceWriterNightlyTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiResXResourceWriterNightlyTests(string scenarioName)
        {
