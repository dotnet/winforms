...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    ///  instead of in parallel. This is to mitigate race conditions of multiple forms open at once.
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiComboBoxTests
    {
        private const string ProjectName = "MauiComboBoxTests";
