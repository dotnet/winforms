...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiNumericUpDownAccelerationTests
    {
        private const string ProjectName = "MauiNumericUpDownAccelerationTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiNumericUpDownAccelerationTests(string scenarioName)
        {
