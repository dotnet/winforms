...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiBackgroundWorkerTests
    {
        private const string ProjectName = "MauiBackgroundWorkerTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiBackgroundWorkerTests(string scenarioName)
        {
