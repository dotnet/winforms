...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicCellEdit_EventsTests
    {
        private const string ProjectName = "MauiDGV_BasicCellEdit_EventsTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicCellEdit_EventsTests(string scenarioName)
        {
