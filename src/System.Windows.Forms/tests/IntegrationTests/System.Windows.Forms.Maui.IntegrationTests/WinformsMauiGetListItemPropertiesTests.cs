...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiGetListItemPropertiesTests
    {
        private const string ProjectName = "MauiGetListItemPropertiesTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiGetListItemPropertiesTests(string scenarioName)
        {
