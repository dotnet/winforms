...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicCellParsingTests
    {
        private const string ProjectName = "MauiDGV_BasicCellParsingTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicCellParsingTests(string scenarioName)
        {
