...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicClickEventsTests
    {
        private const string ProjectName = "MauiDGV_BasicClickEventsTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicClickEventsTests(string scenarioName)
        {
