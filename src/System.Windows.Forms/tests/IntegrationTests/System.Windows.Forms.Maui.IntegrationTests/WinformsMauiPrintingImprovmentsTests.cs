...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiPrintingImprovmentsTests
    {
        private const string ProjectName = "MauiPrintingImprovmentsTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiPrintingImprovmentsTests(string scenarioName)
        {
