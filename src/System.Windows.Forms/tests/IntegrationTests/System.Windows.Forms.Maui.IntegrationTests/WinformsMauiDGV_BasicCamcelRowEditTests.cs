...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicCamcelRowEditTests
    {
        private const string ProjectName = "MauiDGV_BasicCamcelRowEditTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicCamcelRowEditTests(string scenarioName)
        {
