...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiResXDataNodeTextTests
    {
        private const string ProjectName = "MauiResXDataNodeTextTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiResXDataNodeTextTests(string scenarioName)
        {
