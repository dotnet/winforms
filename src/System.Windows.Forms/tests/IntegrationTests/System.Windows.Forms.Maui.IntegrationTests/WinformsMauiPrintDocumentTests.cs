...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiPrintDocumentTests
    {
        private const string ProjectName = "MauiPrintDocumentTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiPrintDocumentTests(string scenarioName)
        {
