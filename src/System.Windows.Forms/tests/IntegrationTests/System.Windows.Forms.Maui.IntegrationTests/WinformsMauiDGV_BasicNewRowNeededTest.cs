...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicNewRowNeededTest
    {
        private const string ProjectName = "MauiDGV_BasicNewRowNeededTest";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicNewRowNeededTest(string scenarioName)
        {
