...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicValidationEventsTests
    {
        private const string ProjectName = "MauiDGV_BasicValidationEventsTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicValidationEventsTests(string scenarioName)
        {
