...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiPrintingSecurityChecksTests
    {
        private const string ProjectName = "MauiPrintingSecurityChecksTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiPrintingSecurityChecksTests(string scenarioName)
        {
