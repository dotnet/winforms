...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiNotifyIconSecurityTests
    {
        private const string ProjectName = "MauiNotifyIconSecurityTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiNotifyIconSecurityTests(string scenarioName)
        {
