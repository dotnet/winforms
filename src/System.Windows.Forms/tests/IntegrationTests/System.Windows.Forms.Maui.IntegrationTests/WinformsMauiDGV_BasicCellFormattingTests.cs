...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDGV_BasicCellFormattingTests
    {
        private const string ProjectName = "MauiDGV_BasicCellFormattingTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDGV_BasicCellFormattingTests(string scenarioName)
        {
