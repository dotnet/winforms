...
namespace System.Windows.Forms.UITests
{
    ...
    public class ListViewInsertionMarkVisualStylesOnTests : ControlTestBase
    {
        ...
        public unsafe void ListViewInsertionMark_AppearsAfterItem_GetInsertMark_Success()
        {
            ...
            Assert.Equal(0, PInvoke.SendMessage((HWND)control.Handle, (User32.WM)ComCtl32.LVM.GETINSERTMARK, 0, ref insertMark));
            Assert.Equal(0x80000000, (uint)insertMark.dwFlags);
            Assert.Equal(-1, insertMark.iItem);
            Assert.Equal(0u, insertMark.dwReserved);
            Assert.Equal(0, (int)PInvoke.SendMessage((HWND)control.Handle, (User32.WM)ComCtl32.LVM.GETINSERTMARKCOLOR));
            ...
            Assert.Equal(1, PInvoke.SendMessage((HWND)control.Handle, (User32.WM)ComCtl32.LVM.GETINSERTMARK, 0, ref insertMark));
        ...
        public unsafe void ListViewInsertionMark_AppearsAfterItem_GetInsertMarkWithColor_Success()
        {
            ...
            Assert.Equal(0, insertMark.iItem);
            Assert.Equal(0u, insertMark.dwReserved);
            Assert.Equal(0x785634, (int)PInvoke.SendMessage((HWND)control.Handle, (User32.WM)ComCtl32.LVM.GETINSERTMARKCOLOR));
        ...
        public unsafe void ListViewInsertionMark_Color_GetInsertMarkColor_Success()
        {
            ...
            Assert.Equal(-1, insertMark.iItem);
            Assert.Equal(0u, insertMark.dwReserved);
            Assert.Equal(00, (int)PInvoke.SendMessage((HWND)control.Handle, (User32.WM)ComCtl32.LVM.GETINSERTMARKCOLOR));
            ...
            Assert.Equal(00, PInvoke.SendMessage((HWND)control.Handle, (User32.WM)ComCtl32.LVM.GETINSERTMARK, 0, ref insertMark));
            Assert.Equal(0x80000000, (uint)insertMark.dwFlags);
            Assert.Equal(-1, insertMark.iItem);
            Assert.Equal(0u, insertMark.dwReserved);
            Assert.Equal(0x785634, (int)PInvoke.SendMessage((HWND)control.Handle, (User32.WM)ComCtl32.LVM.GETINSERTMARKCOLOR));
