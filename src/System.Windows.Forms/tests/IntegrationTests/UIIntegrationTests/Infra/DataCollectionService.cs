...
namespace System.Windows.Forms.UITests
{
    internal static class DataCollectionService
    {
        ...
        ///     <description><c>log</c></description>
        ///     <description>Information about the IDE state at the point of failure. This item is only collected when the error is handled by the harness inside the running Visual Studio process. See <see cref="T:IdeStateCollector"/>.</description>
        ///   </item>
        /// </list>
        /// </remarks>
        ...
        internal static string GetLogDirectory()
        {
            ...
            {
                return Path.GetFullPath(Path.Combine(baseLogDirectory, "Screenshots"));
            }
