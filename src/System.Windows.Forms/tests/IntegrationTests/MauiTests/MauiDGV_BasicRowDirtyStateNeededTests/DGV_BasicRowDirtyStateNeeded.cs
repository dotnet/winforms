...
// Author:      t-timw
//
namespace ystem.Windows.Forms.IntegrationTests.MauiTests
{
    public class MauiDGV_BasicRowDirtyStateNeededTests : ReflectBase
    {

        #region Testcase setup
        public MauiDGV_BasicRowDirtyStateNeededTests(string[] args) : base(args)
        {
        ...
        public static void Main(string[] args)
        {
            ...
            Application.Run(new MauiDGV_BasicRowDirtyStateNeededTests(args));
        }
        DataGridView grid;
        int eventCount = 0;
