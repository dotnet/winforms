...
{
    public class MauiDataBindingAttributes01_ExistenceTests : ReflectBase
    {

        #region Testcase setup
        public MauiDataBindingAttributes01_ExistenceTests(string[] args) : base(args)
        {
        ...
        public static void Main(string[] args)
        {
            ...
            Application.Run(new MauiDataBindingAttributes01_ExistenceTests(args));
        }
