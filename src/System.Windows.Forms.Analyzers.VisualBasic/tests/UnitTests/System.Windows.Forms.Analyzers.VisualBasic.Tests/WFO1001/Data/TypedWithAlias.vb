...
Imports IManagedDataObject = System.Windows.Forms.ITypedDataObject
Imports System.Runtime.Versioning

Namespace System.Windows.Forms.Analyzers.VisualBasic.Tests

    Friend Class TypedWithAlias
        Implements IManagedDataObject, System.Windows.Forms.IDataObject
        ...
        Public Function TryGetData(Of T)(<DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)> ByRef data As T) As Boolean Implements IManagedDataObject.TryGetData
            Throw New NotImplementedException()
        End Function

        Public Function TryGetData(Of T)(format As String, <DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)> ByRef data As T) As Boolean Implements IManagedDataObject.TryGetData
            Throw New NotImplementedException()
        End Function

        Public Function TryGetData(Of T)(format As String, autoConvert As Boolean, <DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)> ByRef data As T) As Boolean Implements IManagedDataObject.TryGetData
            Throw New NotImplementedException()
        End Function

        Public Function TryGetData(Of T)(format As String, resolver As Func(Of TypeName, Type), autoConvert As Boolean, <DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)> ByRef data As T) As Boolean Implements IManagedDataObject.TryGetData
            Throw New NotImplementedException()
        End Function
