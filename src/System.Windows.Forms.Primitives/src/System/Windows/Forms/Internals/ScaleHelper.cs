...
internal static partial class ScaleHelper
{
    ...
    internal static Font? ScaleToSystemTextSize(Font? font)
    {
        ...
        if (!TryGetSystemTextScaleFactor(out double textScaleFactor) || textScaleFactor == DefaultSystemTextScaleFactor)
        {
            return null;
        }
    ...
    internal static double GetSystemTextScaleFactor()
        => TryGetSystemTextScaleFactor(out double textScaleFactor) ? textScaleFactor : DefaultSystemTextScaleFactor;
    ...
    /// </returns>
    internal static bool TryGetSystemTextScaleFactor(out double textScaleFactor)
    {
        ...
        try
        {
            ...
            using RegistryKey? key = Registry.CurrentUser.OpenSubKey(AccessibilityRegistryKeyPath);
            if (key is not null && key.GetValue(TextScaleFactorValueName) is int textScale)
            {
                textScale = Math.Clamp(textScale, MinSystemTextScalePercent, MaxSystemTextScalePercent);
