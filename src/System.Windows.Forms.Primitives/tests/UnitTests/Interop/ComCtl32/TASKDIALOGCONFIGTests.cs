...
public class TASKDIALOGCONFIGTests
{
    ...
    public unsafe void TASKDIALOGCONFIG_x32_ensure_layout()
    {
        ...
        Assert.Equal(24, (byte*)&sut.Anonymous1 - addr);                // 4, union { HICON; PCWSTR; }
        ...
        Assert.Equal(76, (byte*)&sut.Anonymous2 - addr);              // 4, union { HICON; PCWSTR; }
    ...
    public unsafe void TASKDIALOGCONFIG_x64_ensure_layout()
    {
        ...
        Assert.Equal(36, (byte*)&sut.Anonymous1 - addr);                 // 8, union { HICON; PCWSTR; }
        ...
        Assert.Equal(124, (byte*)&sut.Anonymous2 - addr);              // 8, union { HICON; PCWSTR; }
