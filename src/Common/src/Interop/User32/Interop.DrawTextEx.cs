...
internal static partial class Interop
{
    internal static partial class User32
    {
        ...
        private static extern int DrawTextExWInternal(IntPtr hdc, string lpchText, int cchText, ref RECT lprc, TextFormatFlags format, ref DRAWTEXTPARAMS lpdtp);

        public static unsafe int DrawTextExW(IntPtr hdc, string lpchText, int cchText, ref RECT lprc, TextFormatFlags format, ref DRAWTEXTPARAMS lpdtp)
        {
