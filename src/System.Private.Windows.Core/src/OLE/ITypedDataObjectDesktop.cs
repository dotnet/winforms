...
/// <remarks>
///  <para>
///   Implement this interface to use your data object with <see cref="DesktopClipboard.TryGetData{T}(string, out T)"/>
...
///   will throw a <see cref="NotSupportedException"/>. This is replacement of <see cref="IDataObjectDesktop"/>
...
///  </para>
/// </remarks>
public interface ITypedDataObjectDesktop : IDataObjectDesktop
{
    /// <summary>
    ...
    /// </param>
    /// <param name="format">
    ///  A string that specifies what format to retrieve the data as. See the <see cref="DesktopDataFormats"/> class for
