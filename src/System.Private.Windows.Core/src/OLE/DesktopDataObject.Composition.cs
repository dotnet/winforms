...
internal abstract unsafe partial class DesktopDataObject
{
    ...
    internal abstract unsafe partial class Composition : ITypedDataObject, Com.IDataObject.Interface, ComTypes.IDataObject
    {
        ...
        ///  This or one of the other PopulateFromX methods will be called when <see cref="DesktopDataObject"/> is being created.
        /// </summary>
        /// <remarks>
        /// <para>
        ///  Implementation must call <see cref="Populate(IDataObject, Com.IDataObject.Interface, ComTypes.IDataObject)"/>
        ///  before method ends.
        /// </para>
        /// </remarks>
        public abstract Composition PopulateFromRuntimeDataObject(ComTypes.IDataObject runtimeDataObject);

        /// <inheritdoc cref=" PopulateFromRuntimeDataObject(ComTypes.IDataObject)"/>
