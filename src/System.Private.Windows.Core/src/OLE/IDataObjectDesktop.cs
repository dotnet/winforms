...
///  <remarks>
///  <para>
///   When implementing a <see cref="IDataObjectDesktop"/>, consider implementing <see cref="ITypedDataObjectDesktop"/>
///   interface instead. This interface will ensure that only data of a specified <see cref="Type"/>
///   is exchanged. If <see cref="ITypedDataObjectDesktop"/> is not implemented by a data object exchanged
///   in the clipboard or drag and drop scenarios, the APIs that specify a <see cref="Type"/>,
///   such as <see cref="DesktopClipboard.TryGetData{T}(string, out T)"/>, will throw a <see cref="NotSupportedException"/>.
///  </para>
///  </remarks>
public interface IDataObjectDesktop
{
    /// <summary>
