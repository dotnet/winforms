...
/// </summary>
public abstract class DesktopClipboard
{
    /// <summary>
    ...
    public abstract DesktopDataObject WrapForSetDataObject(object data);
    ...
    /// </summary>
    public unsafe IDataObject? GetDataObject()
    {
        EnsureStaThread();
        int retryTimes = 10;
        ...
        return WrapForGetDataObject((nint)(void*)proxyDataObject.Value);
    }

    public abstract DesktopDataObject WrapForGetDataObject(object dataObject);
...
#pragma warning restore CA2201
    ...
    public abstract bool GetTypedDataObject<T>(string format, [NotNullWhen(true), MaybeNullWhen(false)] out ITypedDataObject typed);
    ...
    public abstract DesktopDataObject CreateDataObject(string format, object data);

    public abstract DesktopDataObject CreateDataObject();

    public abstract DesktopDataObject CreateDataObject(string format, bool autoConvert, object data);
