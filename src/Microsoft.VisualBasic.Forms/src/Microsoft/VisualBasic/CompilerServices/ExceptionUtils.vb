...
Namespace Microsoft.VisualBasic.CompilerServices
    ...
    Friend Module ExceptionUtils
        ...
        ''' <summary>
        '''  Returns a new instance of <see cref="ArgumentException"/> with the message from resource file and
        ...
        ''' <summary>
        '''  Returns a new instance of <see cref="ComponentModel.Win32Exception"/>
        ...
        ''' </param>
        ''' <returns>
        '''  A new instance of <see cref="ComponentModel.Win32Exception"/>.
        ''' </returns>
        ''' <remarks>
