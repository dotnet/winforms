...
#Enable Warning WFO5001
        ...
        ''' <summary>
        '''  Setting this property inside the event handler causes a new default Font for Forms
        '''  and UserControls to be set.
        ''' </summary>
        ''' <remarks>
        '''  When the <see cref="WindowsFormsApplicationBase.ApplyApplicationDefaults"/> event is raised,
        '''  this property contains nothing. A new default Font for the application
        ...
        ''' <summary>
        '''  Setting this property inside the event handler determines how long an application's
        '''  Splash dialog is displayed at a minimum.
        ''' </summary>
