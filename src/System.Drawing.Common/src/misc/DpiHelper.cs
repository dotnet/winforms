...
/// <summary>
///  Helper class for scaling coordinates and images according to current DPI scaling
///  set in Windows for the primary screen.
/// </summary>
internal static class DpiHelper
{
    ...
    ///  When displayed on the device, the scaled image will have same size as the original image
    ///  would have when displayed at 96dpi.
    ///  Note: this method should be called only inside an if (DpiHelper.IsScalingRequired) clause
    /// </summary>
