...
namespace System.ComponentModel.Design
{
        ...
        public bool InPushingValue {
            ...
            private event EventHandler FormActivated
            {
                add
                {
                    Events.AddHandler(s_eventFormActivated, value);
                }
                remove
                {
                    Events.RemoveHandler(s_eventFormActivated, value);
                }
            }
            ...
            private event EventHandler FormDeactivate
            {
                add
                {
                    Events.AddHandler(s_eventFormDeactivate, value);
                }
                remove
                {
                    Events.RemoveHandler(s_eventFormDeactivate, value);
                }
            }
            ...
            public static Point ComputePreferredDesktopLocation(Rectangle rectangleAnchor, Size sizePanel, out DockStyle edgeToDock)
            {
                ...
                // Determine where we can draw the panel to minimize clipping. Start with the most preferred position, i.e. bottom-right of anchor
                // For the purposes of computing the flags below, assume the anchor to be small enough to ignore its size.
            ...
            public DesignerActionList ActionList { get => _actionList; set => _actionList = value; }
                ...
                {
                    Color backColor = (_formActive || ActionPanel.DropDownActive) ? _ = ActionPanel.TitleBarColor : ActionPanel.TitleBarUnselectedColor;
            ...
            private class TextBoxPropertyLine : PropertyLine
            {
                ...
                protected Point EditRegionLocation { get; }

                protected Point EditRegionRelativeLocation { get; }

                protected Size EditRegionSize { get; }

                public Point EditRegionRelativeLocation1 { get => _editRegionRelativeLocation; set => _editRegionRelativeLocation = value; }
                ...
                public override Size LayoutControls(int top, int width, bool measureOnly)
                {
                    ...
                    if (!measureOnly)
                    {
                        ...
                        EditRegionRelativeLocation1 = new Point(editRegionXPos, TextBoxTopPadding);
            ...
            private sealed class EditorPropertyLine : TextBoxPropertyLine, IWindowsFormsEditorService, IServiceProvider
            {
                ...
                private void ActivateDropDown()
                {
                    ...
                    listBox.SelectedIndexChanged += new EventHandler(OnListBoxSelectedIndexChanged);
                        ...
                        NativeMethods.CommonHandles.s_gdiHandleCollector.Add();
                ...
                private static class NativeMethods
                {
                    ...
                    {
                        public static HandleCollector s_gdiHandleCollector = new HandleCollector("GDI", 500);
                        public static HandleCollector s_hdcHandleCollector = new HandleCollector("HDC", 2);
                    }
                ...
                private static class SafeNativeMethods
                {
                    ...
                    {
                        NativeMethods.CommonHandles.s_gdiHandleCollector.Remove();
                ...
                private static class UnsafeNativeMethods
                {
                    ...
                    {
                        NativeMethods.CommonHandles.s_hdcHandleCollector.Remove();
