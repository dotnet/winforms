...
namespace System.Windows.Forms.Design
{
    ...
    internal class ToolStripItemBehavior : Behavior.Behavior
    {
        ...
        //  This helper function will return true if any other MouseHandler (say TabOrder UI)
        //  is active, in which case we should not handle any Mouse Messages. Since
        //  the TabOrder UI has backwards compatability requirements, when the TabOrder UI is up,
        //  it adds a new Overlay (a window) to the DesignerFrame (something
        //  similar to AdornerWindow). This UI is a transparent control which has overrides
        //  for Mouse Messages. It listens for all mouse messages through the IMouseHandler
        //  interface instead of using the new  BehaviorService. Hence we have to special
        // case this scenario. ControlDesigner also does this.
