...
public sealed class MenuCommands : StandardCommands
{
    ...
    public static readonly CommandID KeyCancel = new(guidVSStd2K, ECMD_CANCEL);

    public static readonly CommandID KeyReverseCancel = new(wfCommandSet, cmdidReverseCancel);

    public static readonly CommandID KeyInvokeSmartTag = new(guidVSStd2K, ECMD_INVOKESMARTTAG);

    public static readonly CommandID KeyDefaultAction = new(guidVSStd2K, ECMD_RETURN);

    public static readonly CommandID KeyMoveUp = new(guidVSStd2K, ECMD_UP);

    public static readonly CommandID KeyMoveDown = new(guidVSStd2K, ECMD_DOWN);

    public static readonly CommandID KeyMoveLeft = new(guidVSStd2K, ECMD_LEFT);

    public static readonly CommandID KeyMoveRight = new(guidVSStd2K, ECMD_RIGHT);

    public static readonly CommandID KeyNudgeUp = new(guidVSStd2K, ECMD_CTLMOVEUP);

    public static readonly CommandID KeyNudgeDown = new(guidVSStd2K, ECMD_CTLMOVEDOWN);

    public static readonly CommandID KeyNudgeLeft = new(guidVSStd2K, ECMD_CTLMOVELEFT);

    public static readonly CommandID KeyNudgeRight = new(guidVSStd2K, ECMD_CTLMOVERIGHT);

    public static readonly CommandID KeySizeWidthIncrease = new(guidVSStd2K, ECMD_RIGHT_EXT);

    public static readonly CommandID KeySizeHeightIncrease = new(guidVSStd2K, ECMD_UP_EXT);

    public static readonly CommandID KeySizeWidthDecrease = new(guidVSStd2K, ECMD_LEFT_EXT);

    public static readonly CommandID KeySizeHeightDecrease = new(guidVSStd2K, ECMD_DOWN_EXT);

    public static readonly CommandID KeyNudgeWidthIncrease = new(guidVSStd2K, ECMD_CTLSIZERIGHT);

    public static readonly CommandID KeyNudgeHeightIncrease = new(guidVSStd2K, ECMD_CTLSIZEDOWN);

    public static readonly CommandID KeyNudgeWidthDecrease = new(guidVSStd2K, ECMD_CTLSIZELEFT);

    public static readonly CommandID KeyNudgeHeightDecrease = new(guidVSStd2K, ECMD_CTLSIZEUP);

    public static readonly CommandID KeySelectNext = new(guidVSStd2K, ECMD_TAB);

    public static readonly CommandID KeySelectPrevious = new(guidVSStd2K, ECMD_BACKTAB);
    ...
    public static readonly CommandID KeyHome = new(guidVSStd2K, ECMD_HOME);

    public static readonly CommandID KeyEnd = new(guidVSStd2K, ECMD_END);

    public static readonly CommandID KeyShiftHome = new(guidVSStd2K, ECMD_HOME_EXT);

    public static readonly CommandID KeyShiftEnd = new(guidVSStd2K, ECMD_END_EXT);
