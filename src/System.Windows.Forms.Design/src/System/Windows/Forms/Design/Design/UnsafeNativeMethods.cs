...
internal class UnsafeNativeMethods
{
    ...
    [ComImport(), Guid("00000002-0000-0000-c000-000000000046"), InterfaceTypeAttribute(ComInterfaceType.InterfaceIsIUnknown)]
    ...
    [DllImport(Libraries.User32, ExactSpelling = true, EntryPoint = "BeginPaint", CharSet = CharSet.Auto)]
    [ResourceExposure(ResourceScope.None)]
    public static extern IntPtr BeginPaint(IntPtr hWnd, [In, Out] ref PAINTSTRUCT lpPaint);

    [DllImport(Libraries.User32, ExactSpelling = true, EntryPoint = "EndPaint", CharSet = CharSet.Auto)]
    [ResourceExposure(ResourceScope.None)]
    public static extern bool EndPaint(IntPtr hWnd, ref PAINTSTRUCT lpPaint);

    [DllImport(Libraries.User32, ExactSpelling = true, EntryPoint = "GetDC", CharSet = CharSet.Auto)]
    [ResourceExposure(ResourceScope.Process)]
    ...
    [DllImport(Libraries.User32, ExactSpelling = true, EntryPoint = "ReleaseDC", CharSet = CharSet.Auto)]
    [ResourceExposure(ResourceScope.None)]
    ...
    public extern static IntPtr ExtractIcon(HandleRef hMod, string exeName, int index);

    [DllImport(Libraries.User32)]
    [ResourceExposure(ResourceScope.None)]
    public extern static bool DestroyIcon(HandleRef hIcon);
    ...
    [SuppressMessage("Microsoft.Portability", "CA1901:PInvokeDeclarationsShouldBePortable")]
    [DllImport(Libraries.User32, CharSet = CharSet.Auto, EntryPoint = "GetWindowLong")]
    [ResourceExposure(ResourceScope.None)]
    public static extern IntPtr GetWindowLong32(HandleRef hWnd, int nIndex);

    [SuppressMessage("Microsoft.Interoperability", "CA1400:PInvokeEntryPointsShouldExist")]
    [DllImport(Libraries.User32, CharSet = CharSet.Auto, EntryPoint = "GetWindowLongPtr")]
    [ResourceExposure(ResourceScope.None)]
    ...
    [SuppressMessage("Microsoft.Portability", "CA1901:PInvokeDeclarationsShouldBePortable")]
    [DllImport(Libraries.User32, CharSet = CharSet.Auto, EntryPoint = "SetWindowLong")]
    [ResourceExposure(ResourceScope.None)]
    public static extern IntPtr SetWindowLongPtr32(HandleRef hWnd, int nIndex, HandleRef dwNewLong);
    [SuppressMessage("Microsoft.Interoperability", "CA1400:PInvokeEntryPointsShouldExist")]
    [DllImport(Libraries.User32, CharSet = CharSet.Auto, EntryPoint = "SetWindowLongPtr")]
    [ResourceExposure(ResourceScope.None)]
    ...
    [DllImport(Libraries.UiaCore, CharSet = CharSet.Unicode, SetLastError = true)]
    ...
    [System.Security.SuppressUnmanagedCodeSecurity, ComImport(), Guid("0000000C-0000-0000-C000-000000000046"), InterfaceTypeAttribute(ComInterfaceType.InterfaceIsIUnknown)]
