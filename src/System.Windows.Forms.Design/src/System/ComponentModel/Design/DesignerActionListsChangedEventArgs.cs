...
{
    /// <summary>
    ///  Initializes a new instance of the <see cref="DesignerActionListsChangedEventArgs" />
    ///  class with the specified related object, the type of change,
    ///  and the remaining action lists for the related object.
    /// </summary>
