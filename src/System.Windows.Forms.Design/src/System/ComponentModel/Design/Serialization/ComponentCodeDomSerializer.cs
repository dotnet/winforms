    ...
    internal class ComponentCodeDomSerializer : CodeDomSerializer {
        ...
        private Type[] GetContainerConstructor(IDesignerSerializationManager manager) {
            if (_containerConstructor == null) {
                _containerConstructor = new Type[] { GetReflectionTypeFromTypeHelper(manager, typeof(IContainer)) };
            }
        ...
        internal new static ComponentCodeDomSerializer Default {
            get {
                ...
                if (_defaultSerializerRef != null) {
                    defaultSerializer = _defaultSerializerRef.Target as ComponentCodeDomSerializer;
                ...
                _defaultSerializerRef = new WeakReference(defaultSerializer);
                return defaultSerializer;
            }
        }
