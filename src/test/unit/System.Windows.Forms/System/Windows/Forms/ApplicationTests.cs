...
public class ApplicationTests
{
    ...
    // Application_CurrentCulture_Set_GetReturnsExpected,
    // Application_EnableVisualStyles_InvokeBeforeGettingRenderWithVisualStyles_Success,
    // Application_VisualStyleState_Set_ReturnsExpected moved to
    // src/test/integration/UIIntegrationTests/Application.StaticStateTests.cs (issue #4500).
    // Application_EnableVisualStyles_InvokeAfterGettingRenderWithVisualStyles_Success was dropped
    // because its precondition (UseVisualStyles == false) cannot be reproduced without process isolation.
