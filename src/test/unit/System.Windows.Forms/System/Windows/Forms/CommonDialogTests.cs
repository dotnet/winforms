...
public class CommonDialogTests
{
    ...
    // ShowDialog_NonControlOwnerWithVisualStyles_ReturnsExpected,
    // ShowDialog_ControlOwnerWithVisualStyles_ReturnsExpected,
    // ShowDialog_ControlOwnerWithHandleWithVisualStyles_ReturnsExpected moved to
    // src/test/integration/UIIntegrationTests/CommonDialogTests.cs (issue #4500).
