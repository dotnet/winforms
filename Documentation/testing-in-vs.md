...
* `$(MicrosoftNETCoreAppRuntimewinx64PackageVersion)` is set in [Versions.props](https://github.com/dotnet/winforms/blob/70b1367fd01fbbba0e49e9c23f1775418dc50bd2/eng/Versions.props#L16), and gets automatically updated when we ingest dependencies from core-setup. (These PR's are automatically merged in if the build passes)
    * You can see where the dependency comes from by looking at [Version.Details.xml](https://github.com/dotnet/winforms/blob/70b1367fd01fbbba0e49e9c23f1775418dc50bd2/eng/Version.Details.xml#L13)
