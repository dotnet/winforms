...
![Adding new Project to Solution](./images/add-project-to-sln.png)
...
![New WinForms Project Dialog](./images/add-project-to-sln.png)
...
![Renaming namespace](./images/edit-namespace.png)
